...
mod tests {
    ...
    fn test_random1() {
        ...
        //Output to test
        ////////////
        let A = Array::random((7280), Uniform::new(-188., 188.));
        ...
        let my_output = W.relu().reshape(&[10, 728]).matmul(&x) + b;
        let my_output = my_output;
        ...
        let pyout = pyW.relu().reshape([10, 728]).matmul(&pyX) + pyB;
        let pyout = pyout;
